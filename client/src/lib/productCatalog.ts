    ...
    menus: [
      {
        ...
        accessKey: "techboard.overview",
      },
      {
        icon: Users,
        label: "Recursos",
        path: "/techboard/resources",
        permission: "resources",
        accessKey: "techboard.resources",
      },
      {
        icon: FolderKanban,
        label: "Projetos",
        path: "/techboard/projects",
        permission: "projects",
        accessKey: "techboard.projects",
      },
      {
        icon: CalendarOff,
        label: "Férias e ausências",
        path: "/techboard/absences",
        permission: "absences",
        accessKey: "techboard.absences",
      },
      {
        icon: CalendarRange,
        label: "Planner Gantt",
        path: "/techboard/planner",
        permission: "planner",
        accessKey: "techboard.planner",
      },
      {
        icon: Network,
        label: "Organograma",
        path: "/techboard/org-chart",
    ...
    menus: [
      {
        ...
        label: "Visão geral",
        path: "/techlead",
        permission: "gpChecklist",
        accessKey: "techlead.overview",
      },
      {
        icon: ClipboardCheck,
        label: "Trilha do GP",
        path: "/techlead/gp-track",
        permission: "gpChecklist",
        accessKey: "techlead.gpTrack",
      },
      {
        icon: Users,
        label: "Times e frentes",
        path: "/techlead/teams",
        permission: "gpChecklist",
        accessKey: "techlead.teams",
      },
      {
        icon: BarChart3,
        label: "Indicadores",
        path: "/techlead/indicators",
        permission: "gpChecklist",
        accessKey: "techlead.indicators",
      },
    ],
  },
  techmove: {
    ...
    menus: [
      ...
      },
      {
        ...
        path: "/techmove/bdcq",
        permission: "techmove",
        accessKey: "techmove.bdcq",
      },
      {
        icon: Users,
        label: "Workshops",
        path: "/techmove/workshops",
        permission: "techmove",
        accessKey: "techmove.workshops",
      },
      {
        icon: Database,
        label: "DCD",
      ...
      },
      {
        ...
        permission: "techmove",
        accessKey: "techmove.configurations",
      },
      {
        icon: ClipboardCheck,
        label: "Testes",
        path: "/techmove/tests",
        permission: "techmove",
        accessKey: "techmove.tests",
      },
      {
        icon: ShieldCheck,
        label: "Governança",
        path: "/techmove/governance",
        permission: "techmove",
        accessKey: "techmove.governance",
      },
    ],
  },
  techtask: {
    ...
    menus: [
      ...
      },
      {
        ...
        path: "/techtask/board",
        permission: "activities",
        accessKey: "techtask.board",
      },
      {
        icon: ListChecks,
        label: "Meu trabalho",
        path: "/techtask/my-work",
        permission: "activities",
        accessKey: "techtask.myWork",
      },
    ],
  },
  admin: {
...
export function productForPath(path: string): ProductDefinition | undefined {
  ...
  return PRODUCTS.find(
    product =>
      pathname === product.homePath ||
      pathname.startsWith(`${product.homePath}/`)
  );
}
...
export function firstAccessiblePath(
  ...
  return (
    product.menus.find(item => canViewMenuItem(item, permissions))?.path ||
    product.homePath
  );
}
